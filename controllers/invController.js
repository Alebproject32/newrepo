...
            nav,
            detailHTML, 
            reviewHTML, // <-- Nuevo: Lista de reseñas
            errors: null,
            inv_id, // Pasar inv_id a la vista para el formulario de reseña
            // El account_id se asume disponible globalmente a través de res.locals si está logueado
        })
    } catch (error) {
        // Pass the error to the central Express error handler
        next(error)
...
    const accountId = parseInt(account_id) // Asumido pasado vía campo oculto
...
    try {
        // Llama a la función del modelo para insertar la reseña
...
        // Redirige de vuelta a la página de detalle del vehículo para ver la nueva reseña
